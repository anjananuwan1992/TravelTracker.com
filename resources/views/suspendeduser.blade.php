...
<html lang="en">
  <head>
      ...
      <title>Suspended User Accounts</title>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-2 overflow-auto bg-dark" style="height:100vh;">
          ...
          <div class="row"><a class="nav-link" href="suspendeduser">Suspended Accounts</a></div>
        ...
        <div class="col-sm overflow-auto" style="height:100vh;">
          ...
          <div class="col col-md-offset-4 reg-form border rounded-2 border border-2 loginborder">
            ...
            <br>
            <form action="{{route('active2.user')}}" method="post">
              @csrf              
              ...
              <div class="form-group">
                ...
                <a href="/delete-user/{{$user->id}}" class="btn btn-block btn-primary" type="submit">Delete</a>
              </div>
            </form>
          </div>
          @endif
