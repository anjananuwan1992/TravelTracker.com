 ...
 <div class="row">
    ...
    <div class="container-fluid content">
        <div class="row color">
            <div class="col-sm-6">
                <div class="overflow-auto" style= "height:92vh;" id="location-info">
                    ...
                    <h6 id="contact"></h6><h6 id="email"></h6>
                    <h6 id="email"></h6>
                    <br>
        ...
        <script>
          ...
          function initMap() {
              var mycenter = {lat: 7.2906, lng: 80.6336}; //kandy
              ...
              @if($business->type == 'rental-items')
                
                
                var myLatLng_{{ $business->id }} = { lat: {{ $business->latitude }}, lng: {{ $business->longitude }} };
                var iconUrl = '{{ asset('images/purple.PNG') }}'; // Set the default icon URL
