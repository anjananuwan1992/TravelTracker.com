...
<html lang="en">
  ...
  <body class="signuppic">
                  ...
                  <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="/"><img class="img-fluid" style="height:50px" src="{{ asset('images/Logo.png') }}" alt="logo"></a>
                      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="tours">About Us</a>
                        </li>
    ...
    <div class="container d-flex justify-content-center">
      <div class="row border border-white border-3 rounded signupform">
        <div class="col-md">
            <div class="row">
                <div class="signupselect"><a class="signupa" href="Explorer">Register as a Explorer</a> </div><br>
                <div class="signupselect"><a class="signupa" href="guiderregistration">Register as a Tour Guider</a> </div><br>
                <div class="signupselect"><a class="signupa" href="registration">Register as a Business</a></div><br>
            </div>
        </div>
      </div>
    </div>